...
export function newItemFromPalette(palette: Item["t"], x: number, y: number): Item {
  switch (palette) {
    ...
    case "rocks":    return { t: "rocks", x, y, count: 2, baseScale: 1.0 };
    case "lamp":     return { t: "lamp", x, y, scale: 1.8 };
    case "sign":     return { t: "sign", x, y, text: "<Your Text Here>" };
    ...
    case "collider": return { t: "collider", x, y, w: 16, h: 16 }; // 👈 default collider size
  }
}
